-- Kanva Database Schema (PostgreSQL)
-- Migration: Initial schema
-- Uses TEXT for all UUID/timestamp/enum/json fields for sqlx::AnyPool compatibility
...
CREATE TABLE IF NOT EXISTS integrations (
    id TEXT PRIMARY KEY,
    board_id TEXT NOT NULL REFERENCES boards(id) ON DELETE CASCADE,
    provider TEXT NOT NULL CHECK (provider IN ('github', 'gitlab', 'atlassian')),
